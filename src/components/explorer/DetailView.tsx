import { ChevronUp, ChevronDown, Folder, FileText, FileSpreadsheet, File, Image, Video, Music, Archive, Monitor } from "lucide-react";
...
const DetailView = ({ files, selectedFile, onSelect, onDoubleClick, sortColumn, sortAsc, onSort }: DetailViewProps) => {
